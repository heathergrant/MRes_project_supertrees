...
for ii in range(1,Nfolder+1):
    os.system('mkdir replicate%i/QPA_support_gubbins' %ii)

def runp4(foldname):
    try:
        os.chdir(foldname)
        call(["p4", "/home/heather/REALTHING2/code/H_QPA_with_support.py"])
        outhere=True    
    except:
...
for ii in range(1,Nfolder+1):
    foldname='/home/heather/REALTHING2/replicate%i/QPA_support_gubbins' %ii
