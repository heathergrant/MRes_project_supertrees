...
stm = STMcmc(var.trees, bigT=None, modelName='QPA', useSplitSupport='percent', nChains=4, runNum=rNum)
stm.prob.nni = 1.0
#stm.prob.spr = 0.0
...
#tp = TreePartitions("../QPA_use_support_gubbins/mcmc_trees_0.nex", skip=500)
#tp.read("../QPA_use_support_gubbins/mcmc_trees_0.nex", skip=500)
#t = tp.consensus(minimumProportion=0.5)
#for n in t.iterInternalsNoRoot():
#    n.name = "%.0f" % (100. * n.br.support)
#t.draw()
#t.name = 'stMcmc'
#t.writeNexus('QPA_use_support_cons.nex')

#os.system('cp QPA_use_support_cons.nex ../supertrees') 
