...
stm = STMcmc(var.trees, bigT=None, modelName='QPA', nChains=4, runNum=rNum)
stm.prob.nni = 1.0
#stm.prob.spr = 1.0
...
#tp = TreePartitions("../QPA_gubbins/mcmc_trees_0.nex", skip=500)
#tp.read("../QPA_gubbins/mcmc_trees_0.nex", skip=500)
