...
% The scale is 0.000081, and the yScale is 0.700000

%% Coordinates of nodes.
\coordinate (n0) at (0.000,1.575);
\coordinate (n1) at (2.345,2.800);
\coordinate (n1p) at (0.000,2.800);
\coordinate (n2) at (0.791,1.750);
\coordinate (n2p) at (0.000,1.750);
\coordinate (n3) at (0.899,2.100);
\coordinate (n3p) at (0.791,2.100);
\coordinate (n4) at (0.836,1.400);
\coordinate (n4p) at (0.791,1.400);
\coordinate (n5) at (0.823,0.350);
\coordinate (n5p) at (0.000,0.350);
\coordinate (n6) at (0.891,0.700);
\coordinate (n6p) at (0.823,0.700);
\coordinate (n7) at (1.061,0.000);
\coordinate (n7p) at (0.823,0.000);
...
%% scale bar
\coordinate (sb_A) at (3.202,0.000);
\coordinate (sb_B) at (3.000,0.000);
\coordinate (sb_C) at (3.404,0.000);
\draw (sb_B) -- (sb_C);
\node [font=\small,anchor=south,text height=0.248cm,text depth=0.099cm] at (sb_A) {5000.0};
